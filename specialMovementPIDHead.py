...
pid_x = PIDController(kp=0.01, ki=0.002, kd=0.005, buffer_size=5, max_rate=7.0)
pid_y = PIDController(kp=0.01, ki=0.002, kd=0.005, buffer_size=5, max_rate=7.0)
...
coordinates = [[700, 700], [400, 700], [400, 400], [700, 400], [700, 700]]
interval = 100
...
while True:
    ...
    # Update goals when tick hits interval
    if tick % interval == 0:
        current_index = (tick // interval) % len(coordinates)
        goalX = coordinates[current_index][0]
        goalY = coordinates[current_index][1]